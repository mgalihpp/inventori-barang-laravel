<div class="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">Retur</flux:heading>
            <flux:subheading>Daftar transaksi retur barang</flux:subheading>
        </div>
        <flux:button :href="route('transaksi.retur.create')" wire:navigate icon="plus">Tambah</flux:button>
    </div>
    ...
    <flux:table>
        <flux:table.columns>
            ...
            <flux:table.column>Arah</flux:table.column>
        ...
        <flux:table.rows>
            ...
            @empty
                <flux:table.row>
                    <flux:table.cell colspan="7" variant="empty">Belum ada transaksi retur.</flux:table.cell>
                </flux:table.row>
            @endforelse
        </flux:table.rows>
    </flux:table>
